...
本文档描述了health-know项目的API接口规范和使用方法。
...
```bash
# 克隆仓库
git clone https://github.com/MoKangMedical/health-know.git
cd health-know
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('/var/log/health-know/app.log'),
...
- 项目主页: https://github.com/MoKangMedical/health-know
